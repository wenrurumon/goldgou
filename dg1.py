...
printlog([f'log/dg1_{arg1}_{note}.log'],[hidden_dim,latent_dim,dropout_rate,l2_reg,lr,early_tol,patience,patience2,momentum],[num_robots,prop_votes,prop_robots,prop_codes])
